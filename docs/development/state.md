...
**Deps** — ⭐ **ALL EIGHT VERIFIED AGAINST THEIR SIBLING `VERSION` AND A REAL GIT TAG, 2026-08-12**: **bhumi 1.4.1** · **chitra 0.3.0** · rupa 0.1.2 · agnostik 1.3.4 · agnodrm 1.5.0 · kashi 1.0.4 · mehman 1.0.1 · **kavach 3.11.10** · **setu 0.8.5** (now with a `path` override, like every other dep). Siblings: agnos **1.56.44** · puka **0.6.12** · crab **0.4.7**.
