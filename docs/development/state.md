...
| Field | Value | Source |
|---|---|---|
| Version | **0.16.11** (2026-08-19) | [`VERSION`](../../VERSION) |
...
| `--agnos` build | **GREEN** — 0.16.11 is **4,107,920 B · `82633487`**. ⚠ 0.16.10 shared that EXACT byte count under a different hash (`4e8ba754`), and the 6.5.27 -> 6.5.28 pin bump is byte-identical here — verified, not assumed. ⛔ **A SIZE DOES NOT IDENTIFY A BINARY** — 2026-08-12 three distinct artifacts shared one byte count. Quote a hash beside every size | `sha256sum` |
