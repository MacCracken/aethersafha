...
| `--agnos` build | **GREEN** — 0.16.9 is **4,107,920 B · `ec40f2a1`**. ⛔ **A SIZE DOES NOT IDENTIFY A BINARY** — 2026-08-12 three distinct artifacts shared one byte count. Quote a hash beside every size | `sha256sum` |
